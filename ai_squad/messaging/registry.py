...
def load_builtin_providers() -> None:
    ...
    try:
        import ai_squad.messaging.telegram  # noqa: F401
    except ImportError:
        pass

    # CLI — sempre disponível
    try:
        import ai_squad.messaging.cli  # noqa: F401
    except ImportError:
        pass

    # Google Chat — dependência opcional: google-auth, google-api-python-client
    try:
        import ai_squad.messaging.gchat  # noqa: F401
    except ImportError:
        pass

    # TUI — dependência opcional: textual
    try:
        import ai_squad.messaging.tui  # noqa: F401
    except ImportError:
        pass
