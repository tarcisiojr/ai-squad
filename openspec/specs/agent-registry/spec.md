...
Catálogo YAML de agentes com matching automático por domínio e prioridade. Permite extensibilidade sem alteração de código — basta criar diretório do agente e adicionar entrada no registry.yaml.
