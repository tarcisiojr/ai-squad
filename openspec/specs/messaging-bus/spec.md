...
Barramento de mensageria abstrato que desacopla o orquestrador dos canais de comunicação (Telegram, CLI, Slack). Permite troca de provider sem alteração de código.
