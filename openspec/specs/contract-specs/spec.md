...
Estrutura de contratos (OpenAPI, AsyncAPI, schemas) firmados antes do desenvolvimento, permitindo desenvolvimento paralelo entre submodulos e validação automática no CI.
