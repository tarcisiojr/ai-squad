...
Configuração centralizada em platform.yaml para seleção de providers de IA e mensageria, parâmetros globais e configurações por persona — permitindo troca de providers sem alteração de código.
