...
Grafo de conhecimento relacional que conecta entidades e relações extraídas de demandas, lições e resultados de agentes. Usa SQLite com recursive CTEs para traversal e FTS5 para busca. Reforço automático de peso em relações vistas repetidamente.
